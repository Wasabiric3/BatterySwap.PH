...
export function GradientDots({
	...
	return (
		<motion.div
          ...
          radial-gradient(circle at 50% 50%, rgba(255,255,0,0.4), transparent 60%),
          radial-gradient(circle at 50% 50%, rgba(0,255,0,0.4), transparent 60%),
          radial-gradient(ellipse at 50% 50%, rgba(0,0,255,0.4), transparent 60%)
        `,
				backgroundSize: `
